...
%
% GvW 10-6-2008
function [s] = sphereplot(ctr,rs,col,npl)
...
s = surf(rs*xs+ctr(1),rs*ys+ctr(2),rs*zs+ctr(3),'FaceColor',col,'FaceAlpha',0.3,'EdgeColor','none'); % Scale and plot approx. sphere
